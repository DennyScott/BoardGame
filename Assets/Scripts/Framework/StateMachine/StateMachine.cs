...
public class StateMachine<TEnum>
{
	...
	public StateMachine(GameObject g)
	{
		_gameObject = g;
	...
	private bool IsAllowableState(int value)
	{
	...
	public void BindToState(State newState, TEnum state)
	{
		...
		newState.StateMachineProperty(_gameObject, SetState);
	}
	...
	/// </summary>
	private void TriggerStateEnter()
	{
